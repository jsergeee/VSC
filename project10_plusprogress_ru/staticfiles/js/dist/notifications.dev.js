...
$(document).ready(function () {
  ...
  loadNotifications(); // Обновляем каждые 30 секунд

  setInterval(loadNotifications, 30000); // Отметить все как прочитанные
  ...
  $(document).on('click', '.notification-item', function (e) {
    var id = $(this).data('id');
    var link = $(this).data('link'); // Отмечаем как прочитанное
...
function loadNotifications() {
  $.get('/api/notifications/', function (data) {
    // Обновляем бейдж
    updateBadge(data.unread_count); // Обновляем список уведомлений
    ...
    if (data.notifications.length === 0) {
      ...
      $.each(data.notifications, function (i, n) {
        ...
        html += "\n                    <div class=\"notification-item ".concat(unreadClass, "\" data-id=\"").concat(n.id, "\" data-link=\"").concat(n.link, "\">\n                        <div class=\"d-flex\">\n                            <div class=\"notification-icon\">\n                                ").concat(icon, "\n                            </div>\n                            <div class=\"notification-content\">\n                                <div class=\"notification-title\">").concat(n.title, "</div>\n                                <div class=\"notification-message\">").concat(n.message, "</div>\n                                <div class=\"notification-time\">").concat(n.created_ago, "</div>\n                            </div>\n                        </div>\n                    </div>\n                ");
      });
    }
